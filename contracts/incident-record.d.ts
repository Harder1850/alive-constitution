 ...
 */
export type IncidentCategory = 'security_incident' | 'enforcement_violation' | 'unauthorized_access' | 'boundary_breach' | 'audit_failure' | 'manual_trigger';
/**
...
//# sourceMappingURL=incident-record.d.ts.map