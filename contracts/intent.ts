...
export type IntentCategory =
  | 'observe'         // "What changed?", "What broke?", "Why did you do that?"
  | 'inspect'         // "Check the repo", "Check system health", "See if anything is wrong"
  | 'safe_action'     // "Run a safe check", "Show git status", "Clean up temp files"
  | 'guided_action'   // "Fix this if safe", "Try safest option", "What would you do next?"
  | 'unsupported';    // Not in Tier 1 — always rejected with a human-readable reason
