...
export function createFlag(
  partial: Omit<Flag, 'id' | 'emitted_at'> & { id?: string; emitted_at?: number },
): Flag {
  return {
    ...partial,
...
// ─── Backward-compat exports (Slice 1 triage — deprecated, do not use in new code) ──

/** @deprecated — use FlagClass */
export type FlagType =
  | 'threat' | 'anomaly' | 'opportunity' | 'recall'
  | 'contradiction' | 'deadline' | 'degradation' | 'completion' | 'suggestion';
